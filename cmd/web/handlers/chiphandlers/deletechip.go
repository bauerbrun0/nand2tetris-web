...
func (h *Handlers) HandleDeleteChip(w http.ResponseWriter, r *http.Request) {
	...
	chip, err := h.Application.ChipService.DeleteChip(int32(chipId), int32(projectId), userId)
	if err != nil {
